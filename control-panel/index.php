...
$COUNT_WORKERS = count(Worker::all());
$COUNT_PENDING_JOBS = count(Job::getJobsByStatus(0));
$COUNT_PROCESSING_JOBS = count(Job::getJobsByStatus(2));
$COUNT_PAGES = count(Page::all());
$COUNT_CATEGORIES = count(Category::all());
$COUNT_SUPERVISOR = count(Supervisor::all());
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-pink hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to="<?php echo $COUNT_PENDING_JOBS; ?>" data-speed="1000"" data-fresh-interval=" 20"></div>
                            </div>
                        </div>
                    </div>
                </a>
                <a href="manage-property.php?type=1">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-cyan hover-expand-effect">
                            ...
                            <div class="content">
                                <div class="text">PROCESSING JOBS</div>
                                <div class="number count-to" data-from="0" data-to="<?php echo $COUNT_PROCESSING_JOBS; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="manage-pages.php">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-orange hover-expand-effect">
                            ...
                            <div class="content">
                                <div class="text">WORKER REGISTRATIONS</div>
                                <div class="number count-to" data-from="0" data-to="<?php echo $COUNT_WORKERS; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header bg-blue-grey">
                            <h2> SUPERVISOR </h2>
                            <ul class="header-dropdown m-r--5">
                                <div class="number count-to" data-from="0" data-to="<?php echo $COUNT_SUPERVISOR; ?>" data-speed="1500" data-fresh-interval="1"></div>
                            </ul>
                        </div>
                        <div class="body">
                            <div class="list-group">
                                <a href="create-supervisor.php"><button type="button" class="list-group-item">Add New</button></a>
                                <a href="manage-supervisors.php"><button type="button" class="list-group-item">Manage</button></a>

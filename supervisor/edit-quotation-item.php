...
<body class="theme-2">
    ...
    <div class="container">
        <div class="header-bar font-color">
            <i class="fa fa-plus-circle"></i> Edit Quotation Item
            <div class="header-bar-icon">
                <a href="manage-quotation-items.php?id=<?= $QUOTATION_ITEM->quotation; ?>">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-box form-box-inner">
                    <form class="form-horizontal" id="edit-quotation-item-form" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 p-bottom text-input-i">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea id="description" class="form-control title-input" name="description" required="true"><?= $QUOTATION_ITEM->description; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 p-bottom text-input-i">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="amount" class="form-control title-input" autocomplete="off" name="amount" required="true" value="<?= $QUOTATION_ITEM->amount; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row button-add-property">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 p-l-0">
                                ...
                                <input type="submit" name="btn-save" id="btn-update" class="btn btn-info member-btn-mrg" value="Add Quotation Item" />
                                <input type="hidden" name="edit-quotation-item" />

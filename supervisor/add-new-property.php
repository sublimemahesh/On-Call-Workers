                        ...
                        <form class="form-horizontal" id="property-form" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 p-bottom text-input-i">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="email" class="form-control title-input" autocomplete="off" name="email" required="true" value="<?= $SUPERVISOR->email; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 p-bottom text-input-i">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="phone-number" class="form-control title-input phone-inputmask" autocomplete="off" name="phone_number" required="true" value="<?= $SUPERVISOR->phone; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>

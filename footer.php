                ...
                <div class="widget_text">
                    ...
                    <div class="border-paragraphs-footer">
                        ...
                        <div class="widget widget_mailchimp">
                            ...
                            <form class="signup form-inline" action="https://html.modernwebtemplates.com/" method="get">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <p>&copy; <?php echo date("Y"); ?> | Created with  <a href="https://www.synotec.lk/">Synotec Holdings (Pvt) Ltd.</a></p>
            </div>
        </div>
    </div>
</section>
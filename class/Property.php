...
class Property {
    ...
    public function create() {
        ...
        $query = "INSERT INTO `property` ("
                ...
                . $this->email . "', '"
                . mysql_real_escape_string($this->features) . "', '"
                . $this->queue . "', '"
                . 0 . "', '"
    ...
    public function getPropertiesByCategory($category) {
        ...
        $query = "SELECT * FROM `property` WHERE `category` = $category AND `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 ORDER BY `id` DESC";
        $db = new Database();
        $result = $db->readQuery($query);
    ...
    public function getPropertiesByCategoryWithLimit($category, $pageLimit, $setLimit) {
        ...
        $query = "SELECT * FROM `property` WHERE `category` = $category AND `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 
         ORDER BY CASE
    ...
    public function getPropertiesBySupervisor($supervisor) {

        $query = "SELECT * FROM `property` WHERE `supervisor` = $supervisor AND `status` = 1 ORDER BY `id` DESC";
        $db = new Database();
        $result = $db->readQuery($query);
    ...
    public function getPropertiesBySupervisorWithLimit($supervisor, $pageLimit, $setLimit) {

        $query = "SELECT * FROM `property` WHERE `supervisor` = $supervisor AND `status` = 1 
        ORDER BY CASE
        WHEN `is_boosted` = 1 THEN 1
        ELSE 2 END, `boosted_at` DESC, `id` DESC
    ...
    public function getPropertiesBySubCategoryWithLimit($subcategory, $pageLimit, $setLimit) {
        ...
        $query = "SELECT * FROM `property` WHERE `sub_category` = $subcategory AND `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1
         ORDER BY CASE
        WHEN `is_boosted` = 1 THEN 1
        ELSE 2 END, `boosted_at` DESC, `id` DESC
         LIMIT " . $pageLimit . " , " . $setLimit;
    ...
    public function getPropertiesBySubCategory($subcategory) {
        ...
        $query = "SELECT * FROM `property` WHERE `sub_category` = $subcategory AND `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 ORDER BY `id` DESC";
        $db = new Database();
        $result = $db->readQuery($query);
    ...
    public function update() {
        ...
        $query = "UPDATE  `property` SET "
                ...
                . "`email` ='" . $this->email . "', "
                . "`features` ='" . mysql_real_escape_string($this->features) . "', "
                . "`status` ='" . 0 . "', "
                . "`queue` ='" . $this->queue . "', "
    ...
    public function getPropertiseBySupervisorAndStatus($supervisor, $status) {

        $query = "SELECT * FROM `property` WHERE `supervisor` = $supervisor AND `status` = $status ORDER BY `id` DESC";
        $db = new Database();
        $result = $db->readQuery($query);
        $array_res = array();
    ...
    public function getAllPropertiesByActiveSupervisors() {

        $query = "SELECT * FROM `property` WHERE `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 ORDER BY CASE
        WHEN `is_boosted` = 1 THEN 1
        ELSE 2 END, `boosted_at` DESC, `id` DESC";
    ...
    public function getAllPropertiesByLimit($pageLimit, $setLimit) {
        ...
        $query = "SELECT * FROM `property` WHERE `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 ORDER BY `id` DESC LIMIT " . $pageLimit . " , " . $setLimit;
        $db = new Database();
        $result = $db->readQuery($query);
        $array_res = array();
    ...
    public function getDistinctCategoriesBySupervisor($id) {

        $query = "SELECT `category` FROM `property` WHERE `supervisor` = $id AND `status` = 1 GROUP BY `category` ORDER BY `category` ASC";
        $db = new Database();
        $result = $db->readQuery($query);
        $array_res = array();
    ...
    public function getPropertiesBySupervisorAndCategory($id, $category) {

        $query = "SELECT * FROM `property` WHERE `supervisor` = $id AND `status` = 1 AND `category` = $category ORDER BY `id` DESC";
        $db = new Database();
        $result = $db->readQuery($query);
        $array_res = array();
    ...
    public function search($keyword, $category, $subcategory, $district, $city, $pageLimit, $setLimit) {
        ...
        $query = "SELECT * FROM `property` $where AND `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 ORDER BY CASE
        WHEN `is_boosted` = 1 THEN 1
    ...
    public function showPaginationForSearch($keyword, $category, $subcategory, $district, $city, $per_page, $page) {
        ...
        $page_url = "?";
        $query = "SELECT COUNT(*) as totalCount FROM `property`  $where AND `supervisor` IN (SELECT `id` FROM `supervisor` WHERE `is_active` = 1) AND `status` = 1 ORDER BY `id` DESC";
